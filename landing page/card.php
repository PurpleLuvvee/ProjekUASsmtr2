        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index.php">Visi Misi</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        ...
        <div class="products-container">
            ...
            <div class="product" data-name="p-1">
                <img src="images/card/presma.png" alt="">
                <h3>PRESMA</h3>
            </div>

            <div class="product" data-name="p-2">
                <img src="images/card/wapresma.png" alt="">
                <h3>WAPRESMA</h3>
            </div>

            <div class="product" data-name="p-3">
                <img src="images/card/mendagri.png" alt="">
                <h3>MENDAGRI</h3>
            </div>

            <div class="product" data-name="p-4">
                <img src="images/card/mukm.png" alt="">
                <h3>MUKM</h3>
            </div>

            <div class="product" data-name="p-5">
                <img src="images/card/seskab.png" alt="">
                <h3>SESKAB</h3>
            </div>

            <div class="product" data-name="p-6">
                <img src="images/card/admin.png" alt="">
                <h3>ADMIN</h3>
            </div>
